package com.mjdev.base;

import android.content.Intent;

public class launcher_intent extends Intent {
    ...
    public static final class Notification {
        ...
        public static final String NOTIFICATION_WIDGET_SETTINGS_CHANGED = PNAME + "NOTIFICATION_WIDGET_SETTINGS_CHANGED";
        public static final String NOTIFICATION_FRAME_ANIMATION_STARTED = PNAME + "NOTIFICATION_FRAME_ANIMATION_STARTED";
        public static final String NOTIFICATION_FRAME_ANIMATION_STOPPED = PNAME + "NOTIFICATION_FRAME_ANIMATION_STOPPED";
        public static final String NOTIFICATION_TWEEN_ANIMATION_STARTED = PNAME + "NOTIFICATION_TWEEN_ANIMATION_STARTED";
        public static final String NOTIFICATION_TWEEN_ANIMATION_REPEATED = PNAME + "NOTIFICATION_TWEEN_ANIMATION_REPEATED";
        public static final String NOTIFICATION_TWEEN_ANIMATION_ENDED = PNAME + "NOTIFICATION_TWEEN_ANIMATION_ENDED";
    }
    public static final class Action {
        ...
        public static final String ACTION_START_FRAME_ANIMATION = PNAME + "ACTION_START_FRAME_ANIMATION";
        public static final String ACTION_STOP_FRAME_ANIMATION = PNAME + "ACTION_STOP_FRAME_ANIMATION";
        public static final String ACTION_START_TWEEN_ANIMATION = PNAME + "ACTION_START_TWEEN_ANIMATION";
        public static final String ACTION_SCROLL_WIDGET_START = PNAME + "ACTION_SCROLL_WIDGET_START";
        public static final String ACTION_SCROLL_WIDGET_SELECT_ITEM = PNAME + "ACTION_SCROLL_WIDGET_SELECT_ITEM";
        public static final String ACTION_SCROLL_WIDGET_CLOSE = PNAME + "ACTION_SCROLL_WIDGET_CLOSE";
    }
    ...
    public static final class Extra {
        public static final class Scroll {
            ...
            public static final String EXTRA_ITEM_CHILDREN_CLICKABLE = PNAME + "EXTRA_ITEM_CHILDREN_CLICKABLE";
            ...
            public static final String EXTRA_SELECTION_ARGUMENTS = PNAME + "EXTRA_SELECTION_ARGUMENTS";
            public static final String EXTRA_SORT_ORDER = PNAME + "EXTRA_SORT_ORDER";
            public static final String EXTRA_LISTVIEW_LAYOUT_ID = PNAME + "EXTRA_LISTVIEW_LAYOUT_ID";
            ...
            public static final String EXTRA_ITEM_ACTION_VIEW_URI_INDEX = PNAME + "EXTRA_ITEM_ACTION_VIEW_URI_INDEX";
